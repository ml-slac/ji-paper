...
\begin{figure}[bt]
  \begin{center}
        \includegraphics[width=0.45\textwidth]{figures/mass.pdf} \includegraphics[width=0.45\textwidth]{figures/tau21.pdf} \\\includegraphics[width=0.45\textwidth]{figures/dR.pdf}
...
\begin{figure}[bt]
  \begin{center}
        \includegraphics[width=0.99\textwidth]{figures/ROCs_compare.pdf}
